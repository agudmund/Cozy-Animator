...
def setup_logging(debug: bool = False):
    ...
    - File: always DEBUG level, daily rotation via filename
    """
...
def log_call(func):
    """
    Decorator that logs function entry/exit + duration + exceptions.
    Uses short argument representation to keep logs readable.
    """
    ...
    def wrapper(*args, **kwargs):
        ...
        arg_parts = [type(a).__name__ for a in args[1:]]
